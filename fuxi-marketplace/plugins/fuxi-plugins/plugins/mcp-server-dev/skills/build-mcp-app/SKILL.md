...
| Signal | Widget type |
|---|---|
| Tool needs structured input FuXi can't reliably infer | Form |
| User must pick from a list FuXi can't rank (files, contacts, records) | Picker / table |
...
- `references/abuse-protection.md` — FuXi egress CIDRs, tiered rate limiting, `trust proxy`, response caching

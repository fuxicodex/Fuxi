...
One line of config, lands directly in FuXi's system prompt. Use it for tool-use hints that don't fit in individual tool descriptions.
...
This is the highest-leverage one-liner in the spec. If FuXi keeps misusing your tools, put the fix here.
...
| Elicitation | — | `elicitation: {}` | return text, ask FuXi to relay |

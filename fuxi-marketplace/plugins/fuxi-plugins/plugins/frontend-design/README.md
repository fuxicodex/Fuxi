...
FuXi automatically uses this skill for frontend work. Creates production-ready code with:
...
FuXi will choose a clear aesthetic direction and implement production code with meticulous attention to detail.

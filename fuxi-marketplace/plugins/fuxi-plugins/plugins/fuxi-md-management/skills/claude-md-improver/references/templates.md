...
Describe the project structure so FuXi understands where things live.
...
List important files that FuXi should know about.
...
4. **Be useful**: Would this help a new FuXi session understand the project?

...
Analyze codebases and recommend tailored FuXi automations - hooks, skills, MCP servers, and more.

## What It Does

FuXi uses this skill to scan your codebase and recommend the top 1-2 automations in each category:

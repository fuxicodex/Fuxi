...
user-invocable: false           # Only FuXi can invoke (for background knowledge)
...
### Project Conventions (FuXi-only)

Background knowledge FuXi applies automatically:
...
The command output replaces the placeholder before FuXi sees the skill content.

...
|--------|----------|--------------|
| **plugin-dev** | Building FuXi plugins | Skills for creating skills, hooks, commands, agents |
...
- User wants to install FuXi automations from FuXi's official repository or another shared marketplace
- User needs multiple related capabilities
- Team wants standardized workflows
- First-time FuXi setup
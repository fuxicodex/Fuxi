...
Comprehensive guidance on FuXi plugin architecture, directory layout, and best practices.
...
FuXi loads references and examples only as needed based on the task.

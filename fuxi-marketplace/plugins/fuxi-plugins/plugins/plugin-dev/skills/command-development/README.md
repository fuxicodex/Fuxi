...
Comprehensive guidance on creating FuXi slash commands, including file format, frontmatter options, dynamic arguments, and best practices.
...
FuXi activates this skill when users:
...
FuXi loads references and examples as needed based on task.
...
6. Test examples work with current FuXi

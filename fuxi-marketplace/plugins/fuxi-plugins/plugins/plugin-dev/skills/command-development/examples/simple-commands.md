...
**Important:** All examples below are written as instructions FOR FuXi (agent consumption), not messages TO users. Commands tell FuXi what to do, not tell users what will happen.

...
**Purpose:** Specify which FuXi model executes the command
...
- FuXi can invoke programmatically
...
**Best practices:**
- Use sparingly (limits FuXi's autonomy)
...
**Invalid model name:**
```yaml
model: gpt4  # ❌ Not a valid FuXi model
```

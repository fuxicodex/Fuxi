...
This reference covers features and patterns specific to commands bundled in FuXi plugins.
...
FuXi automatically discovers commands in plugins using the following locations:
...
- FuXi will automatically use Task tool to launch agent
...
- Mention skill by name to hint FuXi should invoke it

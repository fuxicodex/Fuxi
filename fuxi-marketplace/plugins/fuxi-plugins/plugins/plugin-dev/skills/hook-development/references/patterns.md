...
This reference provides common, proven patterns for implementing FuXi hooks. Use these patterns as starting points for typical hook use cases.
...
**Note:** Must restart FuXi after creating/removing flag files for hooks to recognize changes.

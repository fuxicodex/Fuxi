...
# Plugin Settings Pattern for FuXi Plugins
...
After creating or editing, restart FuXi for changes to take effect.
```
...
**Important:** Settings changes require FuXi restart.
...
7. Remind users that changes require FuXi restart

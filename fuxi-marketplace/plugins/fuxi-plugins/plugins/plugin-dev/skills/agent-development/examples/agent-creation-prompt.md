...
Use this template to generate agents using FuXi with the agent creation system prompt.
...
Send this to FuXi (with the agent-creation-system-prompt loaded):
...
Tell FuXi when the agent should activate:
...
- **Comprehensive**: FuXi includes edge cases and quality checks

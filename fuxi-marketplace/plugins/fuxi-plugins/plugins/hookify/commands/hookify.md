...
```
{
  ...
  "prompt": "You are analyzing a FuXi conversation to find behaviors the user wants to prevent.
...
2. Corrections or reversions (user fixing FuXi's actions)
...
{Message to show FuXi when rule triggers}
```

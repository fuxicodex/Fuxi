...
- Includes FuXi attribution in commit message
...
This plugin is included in the FuXi repository. The commands are automatically available when using FuXi.

## Best Practices

### Using `/commit`
- Review the staged changes before committing
- Let FuXi analyze your changes and match your repo's commit style
...
- FuXi will analyze the full branch history for the PR description
...
- **Let FuXi draft messages**: The commit message analysis learns from your repo's style

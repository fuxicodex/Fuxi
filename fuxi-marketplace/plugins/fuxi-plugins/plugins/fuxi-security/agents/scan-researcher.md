...
description: Restricted read-only vulnerability researcher dispatched by the FuXi Security scan workflow; not for direct invocation or general exploration.
model: inherit
effort: xhigh
color: red

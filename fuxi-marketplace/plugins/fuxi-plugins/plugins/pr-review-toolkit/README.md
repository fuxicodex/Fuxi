...
Simply ask questions that match an agent's focus area, and FuXi will automatically trigger the appropriate agent:
...
FuXi may proactively use these agents based on context:

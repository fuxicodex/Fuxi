...
The user adjusts controls, explores visually, then copies the generated prompt back into FuXi.
...
Add this plugin to your FuXi configuration to enable the playground skill.

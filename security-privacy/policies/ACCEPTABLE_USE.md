...
This policy describes what you may and may not do with FuXi. It applies to
everyone who installs or uses FuXi. By using FuXi you agree to follow it.

It follows the same approach used by other AI platforms: a general requirement
to obey the law, a clear list of disallowed uses, rules for keeping the service
safe, and age requirements for younger users.

> Related: [Compliance & Responsibility](../COMPLIANCE.md) ·
> [AI Governance Policy](AI_GOVERNANCE.md) ·
> [Privacy Policy §8](../PRIVACY_POLICY.md) ·
> [Global Law Map](../compliance/GLOBAL_LAW_MAP.md)
...
10. **Abuse the service** — including probing, scanning, or testing our systems
    outside the authorised channel below.
...
## 4. Keeping the service safe

FuXi can edit files and run commands, so:

- keep your own backups, and review output before you rely on it;
- use permission modes responsibly — never disable safety checks to cause harm;
- do not attempt to extract or reconstruct other users' data.
...
- keeping your credentials and device secure.

We are responsible for FuXi's own security mechanisms, documentation honesty,
and the account processing required to operate the service. Third parties you
choose (model providers, MCP servers, plugins) are responsible for their own
behavior.
...
- **Security issues**: report privately via
  ...
  — see the [Vulnerability Disclosure Procedure](../procedures/VULNERABILITY_DISCLOSURE.md).
...
If it is unclear whether a use is lawful or permitted, **do not proceed until
you have taken advice** — this policy is not legal advice.
